...
#parser.add_argument('--dataset', type=str, default='/content/drive/MyDrive/capsule/reuters_multilabel_dataset',
#                    help='Options: reuters_multilabel_dataset, MR_dataset, SST_dataset')
####
#parser.add_argument('--dataset', type=str, default='/content/drive/MyDrive/capsule/reuters_multilabel_new',
#                    help='Options: reuters_multilabel_dataset, MR_dataset, SST_dataset')
####
parser.add_argument('--dataset', type=str, default='/content/drive/MyDrive/capsule/twitter',
                    help='Options: reuters_multilabel_dataset, MR_dataset, SST_dataset')
...
#########
if args.model_type == 'capsule-A-CNN':    
    poses, activations = capsule_model_A_CNN(X_embedding, args.num_classes)
##########
